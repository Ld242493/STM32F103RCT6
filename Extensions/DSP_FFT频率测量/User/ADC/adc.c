...
void TIM3_Init(void)
{
  ...
  TIM_TimeBaseStructure.TIM_Period = 99;   // 0.1ms触发ADC采集一次,采样频率10khz
...
void ADC_DMA_Init(void)
{
  ...
  DMA_InitStructure.DMA_BufferSize = SampleNber;
  ...
  ADC_RegularChannelConfig(ADC1, ADC_Channel_10, 1, ADC_SampleTime_1Cycles5);  //1us
  /*  使能外部触发  */
